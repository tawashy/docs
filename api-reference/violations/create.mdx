...
description: API to create a violation entry
---
...
```bash
curl --location 'http://localhost:8082/spsr-api/v1/violations/public' \
...
--form 'imagesDescription=Violation on sidewalk' \
--form 'violationType=NO_TICKET' \
--form 'isSaudi=true' \
--form 'metadata.id=12345' \
--form 'violationReporter.fullName=gyda saleh' \
--form 'violationReporter.identityNumber=1234567890' \
--form 'violationReporter.mobileNumber=0538335646' \
