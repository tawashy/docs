...
* Explore [Authentication](./authentication.mdx) for more security options.

* Learn about [Managing Parking Sites](./api-reference/parking/sites.mdx).

* Check the [Full API Reference](./api-reference/introduction.mdx) for more details.

***

🔜 **Next:** [Authentication](./authentication.mdx)